      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <Nav className="justify-content-end">
            ...
            <Navbar.Text style={{ padding: 10 }}>
              <a href={'https://twitter.com/repopnft'} target={'_blank'} rel="noreferrer" className="social-link-icon">
            ...
            <Navbar.Text style={{ padding: 10 }}>
              <a href={'https://discord.gg/Rm6KMyKBtV'} target={'_blank'} rel="noreferrer" className="social-link-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     className="bi bi-discord social-link-icon" viewBox="0 0 16 16">
                  <path
